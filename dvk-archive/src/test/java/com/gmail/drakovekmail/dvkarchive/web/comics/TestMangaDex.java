...
public class TestMangaDex {
	...
	public void test_get_title_info() {
		...
		String value = "English : <br/> A world where logic does not exist and anything is possible. "
				+ "The only limit is your imagination. Bite-sized comics with dry humor for the "
				+ "broken souls. <br/> <br/> Un monde o&#249; la logique n&#8217;existe pas et "
				+ "o&#249; tout est possible. La seule limite est votre imagination. Des bandes "
				+ "dessin&#233;es mordues.";
		...
		value = "Second story arc of JoJo no Kimyou na Bouken series. <br/> <br/> Takes "
				+ "place in the 1930s, and follows the misadventures of Joseph Joestar, "
				+ "the grandson of Jonathan Joestar, as he fights vampires and ancient "
				+ "super beings with some help from a cybernetically-enhanced Nazi and an "
	...
	public void test_get_dvks() {
		...
		try (DConnectSelenium s_connect = new DConnectSelenium(true, null);
			...
			ArrayList<Dvk> dvks = MangaDex.get_dvks(
					...
					this.temp_dir.getRoot(), cps, false, false);
			//CHECK PAGE 1
			String value;
			...
			File file = new File(this.temp_dir.getRoot(), value);
			assertEquals(file, dvks.get(2).get_dvk_file());
			value = "Randomphilia - Ch 75 - Pg 4_MDX770792-4.jpg";
			file = new File(this.temp_dir.getRoot(), value);
	...
	*/
	...
	public void test_get_downloaded_titles() {
		...
		try(DvkHandler handler = new DvkHandler(prefs, dirs, null)) {
			...
			assertEquals(this.temp_dir.getRoot(), dvks.get(0).get_dvk_file());
